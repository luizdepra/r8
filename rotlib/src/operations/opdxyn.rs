...
mod test_opdxyn {
        ...
        let cases = [
            ...
            TestCase {
                ...
                expected_positions: vec![
                    0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x81, 0x88, 0xC1, 0xC4, 0xC5,
                    0xC8, 0x101, 0x108, 0x141, 0x142, 0x143, 0x144, 0x145, 0x146, 0x147, 0x148,
                ],
            },
    ...
    fn test_opdxyn_exec_with_collisions() {
        ...
        let expected_positions = [
            0x41usize, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x81, 0x88, 0xC1, 0xC4, 0xC5, 0xC8,
            0x101, 0x108, 0x142, 0x143, 0x144, 0x145, 0x146, 0x147, 0x148,
        ];
        for pos in 0..VRAM_WIDTH * VRAM_HEIGHT {
